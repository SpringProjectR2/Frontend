...
export default function Sensor({ label }: Props) {
  ...
  return (
    <View style={{ minHeight: 320 }}>
      ...
      {/* Temperature chart */}
      <Link
        href={{ pathname: '/sensor', params: { label, metric: 'temperature' } }}
        asChild
      >
        <Pressable
        ...
        >
          <View style={{ height: 120, paddingHorizontal: 8 }}>
            ...
            <View style={{ flex: 1 }}>
              <CartesianChart data={data} xKey="time" yKeys={['temperature']}>
                {({ points }) => (
      ...
      {/* Humidity chart */}
      <Link
        href={{ pathname: '/sensor', params: { label, metric: 'humidity' } }}
        asChild
      >
        <Pressable
          accessibilityRole="button"
        ...
        >
          <View style={{ height: 120, paddingHorizontal: 8, paddingTop: 8 }}>
            ...
            <View style={{ flex: 1 }}>
              <CartesianChart data={data} xKey="time" yKeys={['humidity']}>
                {({ points }) => (
